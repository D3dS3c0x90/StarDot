    ...
    function appendGuess(my_guess_list, friend_guess_list){

      my_guess_list.forEach(function(number){
          friendSuggestions.push({
      ...
      friend_guess_list.forEach(function(number){
          mySuggestions.push({
              numbers: number.toString().split('').map(Number),
              result: "Wait"
          });
